document.addEventListener("DOMContentLoaded", function() {
    ...
    const shuffledQuestions = [...questions]; // 複製一份題目陣列以進行隨機化
    ...
    shuffle(shuffledQuestions); // 將題目隨機打亂
    ...
    function loadQuestion() {
        ...
        questionElement.textContent = currentQuestion[0]; // 顯示中文題目
        hintElement.textContent = `Hint: 隊伍的英文是 "${currentQuestion[1]}"`; // 設置英文提示文字
    ...
    function checkAnswer(button, selectedImage) {
        const correctImage = shuffledQuestions[currentQuestionIndex][2]; // 取得當前題目的正確圖片
